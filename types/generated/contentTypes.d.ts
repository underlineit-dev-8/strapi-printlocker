...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    case_study_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::case-study-category.case-study-category'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    data: Schema.Attribute.Component<'shared.data', false>;
...
export interface ApiHelpCentreHelpCentre extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'help-centres';
    singularName: 'help-centre';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    banner2: Schema.Attribute.Component<'shared.banner2', false>;
    carousel: Schema.Attribute.Component<'shared.carousel-content', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    slug: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    splitContent: Schema.Attribute.Component<'shared.split-content', true> &
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    platform: Schema.Attribute.Enumeration<
      ['LinkedIn', 'Facebook', 'Twitter', 'Google', 'Instagram', 'Other']
    > &
      Schema.Attribute.Required;
